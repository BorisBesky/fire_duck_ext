...
struct FirestoreErrorContext {
	...
	FirestoreErrorContext &withMethod(const std::string &m) {
		http_method = m;
		return *this;
	}
	FirestoreErrorContext &withUrl(const std::string &u) {
		url = u;
		return *this;
	}
	FirestoreErrorContext &withStatus(int s) {
		http_status_code = s;
		return *this;
	}
	FirestoreErrorContext &withCollection(const std::string &c) {
		collection = c;
		return *this;
	}
	FirestoreErrorContext &withDocument(const std::string &d) {
		document_id = d;
		return *this;
	}
	FirestoreErrorContext &withProject(const std::string &p) {
		project_id = p;
		return *this;
	}
	FirestoreErrorContext &withDatabase(const std::string &d) {
		database_id = d;
		return *this;
	}
	FirestoreErrorContext &withOperation(const std::string &o) {
		operation = o;
		return *this;
	}
	FirestoreErrorContext &withBatchIndex(size_t i) {
		batch_index = i;
		return *this;
	}
...
public:
	...
	FirestoreError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &context);
	...
	// Error code access
	FirestoreErrorCode code() const noexcept {
		return code_;
	}
	uint32_t code_value() const noexcept {
		return static_cast<uint32_t>(code_);
	}

	// Context access
	const FirestoreErrorContext &context() const noexcept {
		return context_;
	}
...
public:
	...
	FirestoreAuthError(FirestoreErrorCode code, const std::string &message) : FirestoreError(code, message) {
	}
	FirestoreAuthError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &ctx)
...
public:
	...
	FirestorePermissionError(FirestoreErrorCode code, const std::string &message) : FirestoreError(code, message) {
	}
	FirestorePermissionError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &ctx)
	    : FirestoreError(code, message, ctx) {
	}
};
...
public:
	...
	FirestoreNotFoundError(FirestoreErrorCode code, const std::string &message) : FirestoreError(code, message) {
	}
	FirestoreNotFoundError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &ctx)
	    : FirestoreError(code, message, ctx) {
	}
};
...
public:
	...
	FirestoreNetworkError(FirestoreErrorCode code, const std::string &message) : FirestoreError(code, message) {
	}
	FirestoreNetworkError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &ctx)
	    : FirestoreError(code, message, ctx) {
	}
};
...
public:
	...
	FirestoreTypeError(FirestoreErrorCode code, const std::string &message) : FirestoreError(code, message) {
	}
	FirestoreTypeError(FirestoreErrorCode code, const std::string &message, const FirestoreErrorContext &ctx)
	    : FirestoreError(code, message, ctx) {
	}
};
...
struct BatchOperationResult {
	...
	bool all_failed() const {
		return failed == total_requested && total_requested > 0;
	}
	bool all_succeeded() const {
		return succeeded == total_requested;
	}

	void add_failure(size_t idx, const std::string &doc_id, FirestoreErrorCode code, const std::string &msg) {
