...
const char* LogLevelToString(FirestoreLogLevel level) {
    switch (level) {
        case FirestoreLogLevel::DEBUG: return "DEBUG";
        case FirestoreLogLevel::INFO: return "INFO";
        case FirestoreLogLevel::WARN: return "WARN";
        case FirestoreLogLevel::ERROR: return "ERROR";
        case FirestoreLogLevel::NONE: return "NONE";
...
FirestoreLogLevel ParseLogLevel(const std::string& str) {
    ...
    if (upper == "DEBUG") return FirestoreLogLevel::DEBUG;
    if (upper == "INFO") return FirestoreLogLevel::INFO;
    if (upper == "WARN" || upper == "WARNING") return FirestoreLogLevel::WARN;
    if (upper == "ERROR") return FirestoreLogLevel::ERROR;
    if (upper == "NONE" || upper == "OFF") return FirestoreLogLevel::NONE;
...
void FirestoreLogger::SetLogLevel(FirestoreLogLevel level) {
    ...
    if (level != FirestoreLogLevel::NONE &&
        std::dynamic_pointer_cast<NullLogSink>(sink_)) {
...
void FirestoreLogger::Log(FirestoreLogLevel level, const std::string& message,
